...
import 'package:restaurant_consumer/data/model/response/notification_model.dart';
...
class NotificationProvider extends ChangeNotifier {
  ...
  Future<void> initNotificationList(BuildContext context) async {
    ...
    if (apiResponse.response != null && apiResponse.response.statusCode == 200) {
      _notificationList = [];
      apiResponse.response.data.forEach((notificatioModel) => _notificationList.add(notificatioModel));
      notifyListeners();
    } else {
