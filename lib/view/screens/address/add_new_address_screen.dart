...
import 'package:restaurant_consumer/view/screens/address/select_location_screen.dart';
                ...
                Container(
                  ...
                  child: !locationProvider.isLoading ? CustomButton(
                    ...
                    onTap: locationProvider.loading ? null : () {
                      ...
                      if(!_isAvailable) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getTranslated('service_is_not_available', context)), backgroundColor: Colors.red));
                      }else {
                        AddressModel addressModel = AddressModel(
                          ...
                          id: locationProvider.addressList.length+1,
                          userId: 1,
                        );
                        if (isEnableUpdate) {
