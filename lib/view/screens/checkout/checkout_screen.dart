...
import 'package:restaurant_consumer/data/model/body/place_order_body.dart';
...
import 'package:restaurant_consumer/view/screens/address/add_new_address_screen.dart';
import 'package:restaurant_consumer/view/screens/checkout/widget/custom_check_box.dart';
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(physics: BouncingScrollPhysics(), children: [
                      ...
                      _isDigitalPaymentActive ? CustomCheckBox(title: getTranslated('digital_payment', context), index: _isCashOnDeliveryActive ? 1 : 0) : SizedBox(),
                    ...
                    child: !order.isLoading ? Builder(
                      builder: (context) => CustomButton(btnTxt: getTranslated('confirm_order', context), onTap: () {
                        if(widget.amount < Provider.of<SplashProvider>(context, listen: false).configModel.minimumOrderValue) {
                          ...
                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => OrderSuccessfulScreen(orderID: '1', addressID: 1)));
                        }
                      }),
                    ) : Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Theme.of(context).primaryColor))),
                  ),
