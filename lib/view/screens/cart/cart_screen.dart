...
import 'package:restaurant_consumer/view/screens/cart/widget/cart_product_widget.dart';
import 'package:restaurant_consumer/view/screens/cart/widget/delivery_option_button.dart';
import 'package:restaurant_consumer/view/screens/checkout/checkout_screen.dart';
                            ...
                            if(_couponController.text.isNotEmpty && !coupon.isLoading) {
                              if(coupon.discount < 1) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('You got discount'), backgroundColor: Colors.green));
                              } else {
