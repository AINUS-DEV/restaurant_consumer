...
import 'package:restaurant_consumer/helper/price_converter.dart';
...
import 'package:restaurant_consumer/view/base/custom_divider.dart';
import 'package:restaurant_consumer/view/base/map_widget.dart';
import 'package:restaurant_consumer/view/screens/order/widget/change_method_dialog.dart';
import 'package:restaurant_consumer/view/screens/order/widget/order_cancel_dialog.dart';
import 'package:restaurant_consumer/view/screens/rare_review/rate_review_screen.dart';
import 'package:restaurant_consumer/view/screens/track/order_tracking_screen.dart';
                    ...
                    Row(children: [
                      ...
                      Expanded(flex: 8, child: Row(children: [
                        ...
                        (order.trackModel.paymentStatus != 'paid' && order.trackModel.paymentMethod != 'cash_on_delivery'
                          ...
                          onTap: () {
                            showDialog(context: context, builder: (_) => ChangeMethodDialog(orderID: order.trackModel.id.toString(), callback: (String message, bool isSuccess) {
              ...
              !order.showCancelled ? Row(children: [
                ...
                (order.trackModel.paymentStatus == 'unpaid' && order.trackModel.paymentMethod != 'cash_on_delivery' && order.trackModel.orderStatus
                  ...
                  child: CustomButton(
                    ...
                    onTap: () async {
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => OrderSuccessfulScreen(orderID: orderId.toString(), addressID: order.trackModel.deliveryAddressId)));
                    },
                  ),
                )) : SizedBox(),
              ]) : Container(
